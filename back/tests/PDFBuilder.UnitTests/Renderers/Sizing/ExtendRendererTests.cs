...
/// <summary>
/// Unit tests for the ExtendRenderer class.
/// </summary>
public sealed class ExtendRendererTests : IDisposable
{
    private readonly Mock<ILogger<ExtendRenderer>> _loggerMock;
    ...
    private readonly ExtendRenderer _renderer;

    public ExtendRendererTests()
    {
        _loggerMock = new Mock<ILogger<ExtendRenderer>>();
        ...
        _renderer = new ExtendRenderer(_expressionEvaluator, _styleResolver, _loggerMock.Object);
    }
    ...
    [Fact]
    public void ComponentType_ShouldBeExtend()
    {
        // Assert
        _renderer.ComponentType.Should().Be(ComponentType.Extend);
    }

    [Fact]
    public void RendererName_ShouldBeExtendRenderer()
    {
        // Assert
        _renderer.RendererName.Should().Be("ExtendRenderer");
    }
    ...
    {
        // Arrange
        var node = new LayoutNode { Type = ComponentType.Extend, Id = "test-extend" };
